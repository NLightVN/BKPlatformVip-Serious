...
class AddressMapperTest {
    ...
    void map_validWardCode_returnsWard() {
        ...
        Ward result = ReflectionTestUtils.invokeMethod(Objects.requireNonNull(addressMapper), "mapWardCodeToEntity",
                "001");
        // mapWardCodeToEntity là protected, không thể gọi trực tiếp từ test.
        // ReflectionTestUtils.invokeMethod cho phép gọi phương thức protected/private
        // bằng reflection.
        // Ở đây nó gọi addressMapper.mapWardCodeToEntity("001") và trả về Ward kết quả.
        // Assert
    ...
    void map_wardNotFound_throwsException() {
        ...
        // chay & Assert
        AppException exception = assertThrows(AppException.class, () -> ReflectionTestUtils
                .invokeMethod(Objects.requireNonNull(addressMapper), "mapWardCodeToEntity", "999"));

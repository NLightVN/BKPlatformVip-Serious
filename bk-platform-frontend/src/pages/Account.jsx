                                    ...
                                    <div style={{ marginTop: '10px' }}>
                                        ...
                                        {!isEditingAddress ? (
                                            ...
                                            <div style={{ padding: '15px', background: '#f5f5f5', borderRadius: '8px' }}>
                                                {user.address ? (
                                                    <>
                                                        <div style={{ fontWeight: 'bold', marginBottom: '5px' }}>{user.address.name || user.fullname}</div>
                                                                        ...
                                                                        <div style={{ paddingLeft: '10px', borderLeft: '3px solid #ddd' }}>
                                                                            {order.items?.map((item, idx) => (
                                                                                <div key={idx} style={{ fontSize: '14px', marginBottom: '5px' }}>
                                                                                    • {item.productName || item.product?.name || 'Sản phẩm không còn tồn tại'} (x{item.quantity}) - {item.priceAtPurchase.toLocaleString()} đ
                                                                                    {item.product?.deleted && <span style={{ color: '#999', fontSize: '12px' }}> (Đã ngừng bán)</span>}
                                                                                </div>
                                                                            ))}
                                                                        </div>

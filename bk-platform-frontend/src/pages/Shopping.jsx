...
const Shopping = () => {
    ...
    const filteredProducts = products.filter(product => {
        // Ẩn sản phẩm bị BANNED hoặc DELETED khỏi marketplace
        if (product.status === 'BANNED' || product.status === 'DELETED') return false;
    ...
    return (
        <div className="app-container">
            ...
            <div className="container" style={{ display: 'flex', gap: '30px', padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
                {/* SIDEBAR */}
                ...
                <section style={{ flex: 1 }}>
                    ...
                    {loading ? (
                        ...
                        <div className="product-grid-view" style={{
                            display: 'grid',
                            ...
                            {sortedProducts.map(product => (
                                <div key={product.productId} className="card" style={{ display: 'flex', flexDirection: 'column', height: '100%', background: 'white', borderRadius: '10px', overflow: 'hidden', border: '1px solid #eee' }}>
                                    <Link to={`/product/${product.productId}`} style={{ textDecoration: 'none', color: 'inherit', display: 'flex', flexDirection: 'column', flex: 1 }}>
